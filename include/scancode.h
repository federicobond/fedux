/* Two defines for every scancode:
   ...
   Source: "Fossies" - the Fresh Open Source Software archive
			Member "rdesktop-1.7.1/scancodes.h" of archive rdesktop-1.7.1.tar.gz:
*/
...
#define SCANCODE_KEY_75 (SCANCODE_EXT | 0x52)
#define SCANCODE_CHAR_INSERT SCANCODE_KEY_75

#define SCANCODE_KEY_76 (SCANCODE_EXT | 0x53)
...
#define SCANCODE_KEY_80 (SCANCODE_EXT | 0x47)
#define SCANCODE_CHAR_HOME SCANCODE_KEY_80

#define SCANCODE_KEY_81 (SCANCODE_EXT | 0x4f)
...
#define SCANCODE_KEY_85 (SCANCODE_EXT | 0x49)
#define SCANCODE_CHAR_PAGEUP SCANCODE_KEY_85

#define SCANCODE_KEY_86 (SCANCODE_EXT | 0x51)
...
#define SCANCODE_KEY_95 (SCANCODE_EXT | 0x35)
...
#define SCANCODE_KEY_108 (SCANCODE_EXT | 0x1c)
...
#define SCANCODE_CHAR_LWIN (SCANCODE_EXT | 0x5b)

#define SCANCODE_CHAR_RWIN (SCANCODE_EXT | 0x5c)

#define SCANCODE_CHAR_APPLICATION (SCANCODE_EXT | 0x5d)

#define SCANCODE_CHAR_ACPIPOWER (SCANCODE_EXT | 0x5e)

#define SCANCODE_CHAR_ACPISLEEP (SCANCODE_EXT | 0x5f)

#define SCANCODE_CHAR_ACPIWAKE (SCANCODE_EXT | 0x63)
